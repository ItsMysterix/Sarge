  ...
  return (
    <AppShell>
      <div className="flex flex-col h-full">
        {/* Minimal Header */}
        <div className="h-16 px-6 border-b border-border/40 flex items-center justify-between bg-black/20 backdrop-blur-sm sticky top-0 z-10">
          <div className="flex items-center gap-4">
             ...
             <div className="flex flex-col">
                <h1 className="text-sm font-semibold tracking-wide">{displayProject.name}</h1>
                <span className="text-[10px] text-muted-foreground font-mono">{displayProject.slug}</span>
             </div>
          </div>
          <div className="flex items-center gap-2">
             <div className="relative">
                <input 
                  placeholder="Search" 
                  className="bg-zinc-900/50 border border-white/5 rounded-full text-xs px-3 py-1.5 w-48 text-muted-foreground focus:outline-none focus:border-white/10 focus:text-foreground transition-all"
                />
                <div className="absolute right-2 top-1/2 -translate-y-1/2 flex gap-1">
                   <kbd className="text-[9px] bg-white/5 px-1 rounded text-muted-foreground">⌘</kbd>
                   <kbd className="text-[9px] bg-white/5 px-1 rounded text-muted-foreground">K</kbd>
                </div>
             </div>
          </div>
        </div>
