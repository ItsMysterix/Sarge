          ...
          <div className="flex flex-col md:flex-row gap-4 mb-6">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 glass-card border border-white/10 rounded-lg bg-transparent text-white placeholder-gray-400 focus:outline-none focus:border-accent/50"
              />
            </div>
            ...
            <label className="glass-card px-4 py-2 text-accent hover:bg-accent/20 border border-accent/30 flex items-center space-x-2 rounded-lg cursor-pointer">
            ...
            <button className="glass-card px-4 py-2 text-accent hover:bg-accent/20 border border-accent/30 flex items-center space-x-2 rounded-lg">
